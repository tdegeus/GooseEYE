...
The weighted correlation characterises the average indicator :math:`\mathcal{I}` around high weight factor :math:`\mathcal{W}`.
...
.. note::
  ...
  .. math::
    ...
    \frac{
      ...
      \left[ \mathcal{I}(\vec{x}_i + \Delta \vec{x}) (1-\mathcal{M})(\vec{x}_i + \Delta \vec{x}) \right]
    }{
      \sum_{i}\;
      \left[ \mathcal{W} (\vec{x}_i) \right] \;
