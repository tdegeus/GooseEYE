...
#
# GooseEYE_FOUND - true if GooseEYE found GooseEYE_VERSION - GooseEYE's version
...
#
# GooseEYE::compiler_warnings - enable compiler warnings GooseEYE::assert -
# enable GooseEYE assertions GooseEYE::debug - enable all assertions (slow)
...
if(NOT TARGET GooseEYE)
  ...
  get_target_property(GooseEYE_INCLUDE_DIRS GooseEYE
...
if(NOT TARGET GooseEYE::compiler_warnings)
  ...
  if(MSVC)
    set_property(TARGET GooseEYE::compiler_warnings
                 PROPERTY INTERFACE_COMPILE_OPTIONS /W4)
  else()
    set_property(
      TARGET GooseEYE::compiler_warnings
      PROPERTY INTERFACE_COMPILE_OPTIONS -Wall -Wextra -pedantic
               -Wno-unknown-pragmas)
  endif()
endif()
...
if(NOT TARGET GooseEYE::warnings)
  ...
  set_property(
    TARGET GooseEYE::warnings PROPERTY INTERFACE_COMPILE_DEFINITIONS
...
if(NOT TARGET GooseEYE::assert)
  ...
  set_property(TARGET GooseEYE::assert PROPERTY INTERFACE_COMPILE_DEFINITIONS
...
if(NOT TARGET GooseEYE::debug)
  ...
  set_property(
    ...
    PROPERTY INTERFACE_COMPILE_DEFINITIONS XTENSOR_ENABLE_ASSERT
             GOOSEEYE_ENABLE_ASSERT)
endif()
